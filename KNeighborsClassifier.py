...
#test_set, train_set= np.split(df, [int(.1364*len(df))])
#train_set.to_csv("my.csv", encoding='utf-8')
...
X_valid = valid_test[['Year','Team1FGA','Team1FG%','Team13PA','Team1REB','Team1TOV','Team1STL','Team2FGA','Team2FG%','Team23PA','Team2REB','Team2TOV','Team2STL']]
